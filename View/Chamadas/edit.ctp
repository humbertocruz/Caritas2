				...
				$.ajax({
					...
					'success': function(data) {
						...
						$.each(data, function(i, item) {
							if (contato_id == item['Contato']['id']) selected = 'selected="selected"'; else selected = '';
							contato+= '<option ' + selected + ' value="'+item['Contato']['id']+'">'+item['Contato']['nome']+' - '+item['SituacoesContato']['nome']+'</option>';
