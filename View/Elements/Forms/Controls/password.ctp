...
?>
		<div class="control-group <?php echo (isset($fieldError)?'error':NULL);?>">
			...
			<div class="controls">
				<input type="password" id="fld_<?php echo $ctrl_field['field'];?>" name="data[<?php echo $model;?>][<?php echo $ctrl_field['field'];?>]" value="<?php echo (isset($this->data[$model][$ctrl_field['field']]) ? $this->data[$model][$ctrl_field['field']] : ''); ?>">
